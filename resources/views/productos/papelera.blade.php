        ...
        <div class="col-md-12">
            <div class="panel panel-primary panel-colorful media middle pad-all">
                <div class="media-body">
                    <p class="text-2x mar-no text-semibold">Productos | Papelera</p>
                    <p></p>
                </div>
            </div>
        </div>
        ...
        <div id="page-content">
            ...
            <div class="panel">
                ...
                <div class="panel-footer text-left">
                    <a href="{{ route('productos.index') }}" class="text-right fs-6 text-secundario add-tooltip"
                            ...
                            @foreach ($productos as $producto)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('productos.activar', $producto) }}" method="POST"
                                        ...
                                        <form action="{{ route('productos.borrar', $producto) }}" method="POST"
