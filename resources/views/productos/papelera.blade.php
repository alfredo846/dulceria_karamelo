@extends('layouts.main')
  @section('title', 'Producto papelera')
                ...
                <br>
				     <div class="col-md-12">
					     ...
					     <div class="media-body">
					         <p class="text-2x mar-no text-semibold">Productos | Papelera</p><p></p>
					     </div>
					 </div>
		   </div>
		   <br><br><br>
                ...
                <div id="page-content">
					...
					<div class="panel">
                          ...
                          <div class="panel-footer text-left">
                             <a href="{{ route('productos.index') }}" class="text-right fs-6 text-secundario add-tooltip" data-toggle="tooltip" data-container="body" data-placement="top" data-original-title="Regresar"><img src="{{ asset('assets/img/regresar.jpg')}}" width="30" height="30"></a>
                          </div>
						<div class="content">
					                ...
					                <tr>
					                  ...
					                  <td>
										...
										<form action="{{ route('productos.activar', $producto) }}" method="POST"  style="display: inline-block" class="formulario-activar" >
											...
											<form action="{{ route('productos.borrar', $producto) }}" method="POST" style="display: inline-block" class="formulario-borrar" >
												@csrf
												@method('DELETE')
