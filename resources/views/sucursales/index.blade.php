                ...
                <br>
				     <div class="col-md-12">
					     ...
					     <div class="media-body">
					         <p class="text-2x mar-no text-semibold">Sucursales | Listado</p><p></p>
					     </div>
					 </div>
		   </div>
		   <br><br><br>
                ...
                <div id="page-content">
					...
					<div class="panel">
						...
						<button id="deleteItem" type="submit" class="btn btn-circle btn-success btn-icon add-tooltip"
							...
							<a href="{{ route('sucursales.create') }}"> <button class="btn btn-success"><i class="ion-plus-circled lg"></i> Agregar nueva sucursal</button></a>
					    </div><br>
					        ...
					        <table id="sucursales" class="table table-striped table-bordered" cellspacing="0" width="100%">
					            ...
					            <tbody>
					                ...
					                <tr>
										...
										<td><img class='profile-image' src="{{ asset('imagenes/sucursales/' . $sucursal->imagen) }}" alt="foto"></td>
					                    ...
					                    <td width="140">
											...
											<form action="{{ route('sucursales.destroy', $sucursal) }}" method="POST" style="display: inline-block" class="formulario-eliminar" >
												@csrf
												@method('DELETE')
