        ...
        <div class="col-md-12">
            <div class="panel panel-primary panel-colorful media middle pad-all">
                <div class="media-body">
                    <p class="text-2x mar-no text-semibold">Categorías | Papelera</p>
                    <p></p>
                </div>
            </div>
        </div>
                            ...
                            @foreach ($categorias as $categoria)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('categorias.activar', $categoria) }}" method="POST"
                                        ...
                                        <form action="{{ route('categorias.borrar', $categoria) }}" method="POST"
