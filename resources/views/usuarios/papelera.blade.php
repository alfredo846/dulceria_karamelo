@extends('layouts.main')
  @section('title', 'Usuario papelera')
                ...
                <br>
				     <div class="col-md-12">
					     ...
					     <div class="media-body">
					         <p class="text-2x mar-no text-semibold">Usuarios | Papelera</p><p></p>
					     </div>
					 </div>
		   </div>
		   <br><br><br>
                ...
                <div id="page-content">
					...
					<div class="panel">
                          ...
                          <div class="panel-footer text-left">
                             <a href="{{ route('usuarios.index') }}" class="text-right fs-6 text-secundario add-tooltip" data-toggle="tooltip" data-container="body" data-placement="top" data-original-title="Regresar"><img src="{{ asset('assets/img/regresar.jpg')}}" width="30" height="30"></a>
                          </div>
						<div class="content">
					            ...
					            <tbody>
                                    ...
                                    @endif
					                  ...
					                  <td>
										...
										<form action="{{ route('usuarios.activar', $usuario) }}" method="POST"  style="display: inline-block" class="formulario-activar" >
											@csrf
											@method('DELETE')
												<button type="submit" class="btn btn-sm btn-success btn-icon">Activar</button>
											</form>

											<form action="{{ route('usuarios.borrar', $usuario) }}" method="POST" style="display: inline-block" class="formulario-borrar" >
												@csrf
												@method('DELETE')
