        ...
        <div class="col-md-12">
            <div class="panel panel-primary panel-colorful media middle pad-all">
                <div class="media-body">
                    <p class="text-2x mar-no text-semibold">Usuarios | Papelera</p>
                    <p></p>
                </div>
            </div>
        </div>
        ...
        <div id="page-content">
            ...
            <div class="panel">
                ...
                <div class="panel-footer text-left">
                    <a href="{{ route('usuarios.index') }}" class="text-right fs-6 text-secundario add-tooltip"
                            ...
                            @foreach ($usuarios as $usuario)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('usuarios.activar', $usuario) }}" method="POST"
                                        ...
                                        <form action="{{ route('usuarios.borrar', $usuario) }}" method="POST"
