                                            ...
                                            @foreach ($productos as $producto)
                                                @if ($producto->producto_id == $articulo->producto_id)
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group mar-btm">
                                                                    ...
                                                                    <input type="text" name="precio_compra_unidad"
                                                                        ...
                                                                        autocomplete="off" class="form-control"
                                                                        pattern="^[0-9,.]*$"
                                                                        value="{{ $articulo->precio_compra_unidad }}"
                                                                        onkeypress="return filterFloat(event,this);">
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group mar-btm">
                                                                        ...
                                                                        <input type="text" name="precio_venta_unidad"
                                                                            ...
                                                                            value="{{ $articulo->precio_venta_unidad }}"
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group mar-btm">
                                                                    ...
                                                                    <input type="text" name="stock_minimo"
                                                                        value="{{ $articulo->stock_minimo }}" required
                                                                        pattern="^[0-9]*$"
                                                                        onKeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group mar-btm">
                                                                    ...
                                                                    <input type="text" name="stock_maximo"
                                                                        value="{{ $articulo->stock_maximo }}" required
                                                                        pattern="^[0-9]*$"
                                                                        onKeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;"
                                                        ...
                                                        <div class="col-sm-3">
                                                            <div class="form-group">
                                                                <label class="control-label is-required">Inventario inicial
                                                                    en
                                                                    @foreach ($empaques as $empaque)
                                                                        @if ($producto->empaque_id == $empaque->empaque_id)
                                                                            {{ $empaque->nombre }}s
                                                                ...
                                                                <div class="input-group mar-btm">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        value="{{ $articulo->inventario_inicial_empaque }}"
                                                                        onKeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group mar-btm">
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            value="{{ $articulo->inventario_inicial_unidad }}"
                                                                            required
                                                                            onKeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;"
                                                                            placeholder="Inventario inicial"
                                                                            autocomplete="off" maxlength="6"
                                                ...
                                                @endif
                                            @endforeach
                                            {{-- End de productos Activos --}}

                                              {{-- Start de productos Inactivos --}}
