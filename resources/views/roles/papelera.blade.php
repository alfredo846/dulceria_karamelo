                ...
                <br>
				     <div class="col-md-12">
					     ...
					     <div class="media-body">
					         <p class="text-2x mar-no text-semibold">Roles | Papelera</p><p></p>
					     </div>
					 </div>
		   </div>
		   <br><br><br>
                ...
                <div id="page-content">
					...
					<div class="panel">
                          ...
                          <div class="panel-footer text-left">
                             <a href="{{ route('roles.index') }}" class="text-right fs-6 text-secundario add-tooltip" data-toggle="tooltip" data-container="body" data-placement="top" data-original-title="Regresar"><img src="{{ asset('assets/img/regresar.jpg')}}" width="30" height="30"></a>
                          </div>
						<div class="content">
					        ...
					        <table id="roles" class="table table-striped table-bordered" cellspacing="0" width="100%">
					            ...
					            <tbody>
					                ...
					                <tr>
										...
										<form action="{{ route('roles.activar', $rol) }}" method="POST"  style="display: inline-block" class="formulario-activar" >
											@csrf
											@method('DELETE')
												<button type="submit" class="btn btn-sm btn-success btn-icon">Activar</button>
											</form>

											<form action="{{ route('roles.borrar', $rol) }}" method="POST" style="display: inline-block" class="formulario-borrar" >
												@csrf
												@method('DELETE')
