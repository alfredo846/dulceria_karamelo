                ...
                <br>
				     <div class="col-md-12">
					     ...
					     <div class="media-body">
					         <p class="text-2x mar-no text-semibold">Empaques | Listado</p><p></p>
					     </div>
					 </div>
		   </div>
		   <br><br><br>
                ...
                <div id="page-content">
					...
					<div class="panel">
						...
						<button id="deleteItem" type="submit" class="btn btn-circle btn-success btn-icon add-tooltip"
							...
							<a href="{{ route('empaques.create') }}"> <button class="btn btn-success"><i class="ion-plus-circled lg"></i> Agregar nueva empaque</button></a>
					    </div><br>
					            ...
					            <tbody>
					                ...
					                <tr>
					                    ...
					                    <td>
											...
											<form action="{{ route('empaques.destroy', $empaque) }}" method="POST" style="display: inline-block" class="formulario-eliminar" >
												@csrf
												@method('DELETE')
