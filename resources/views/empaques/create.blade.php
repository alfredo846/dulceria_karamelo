        ...
        <div class="col-md-12">
            <div class="panel panel-info panel-colorful media middle pad-all" style="background-color:#783449">
                <div class="media-body">
                    <p class="text-2x mar-no text-semibold"> Agregar Empaque</p>
                    <p></p>
                </div>
            </div>
        </div><br><br><br>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="panel">
                        ...
                        <form action="{{ route('empaques.store') }}" method="post" enctype="multipart/form-data"
