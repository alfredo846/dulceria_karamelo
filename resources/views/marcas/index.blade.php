                ...
                <div id="page-content">
					...
					<div class="panel">
						...
						<button id="deleteItem" type="submit" class="btn btn-circle btn-success btn-icon add-tooltip"
							...
							<a href="{{ route('marcas.create') }}"> <button class="btn btn-success"><i class="ion-plus-circled lg"></i> Agregar nueva marca</button></a>
					    </div><br>
					            ...
					            <tbody>
					                ...
					                <tr>
					                    ...
					                    <td>
											...
											<form action="{{ route('marcas.destroy', $marca) }}" method="POST" style="display: inline-block" class="formulario-eliminar" >
												@csrf
												@method('DELETE')
