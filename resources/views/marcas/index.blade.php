        ...
        <div class="col-md-12">
            <div class="panel panel-primary panel-colorful media middle pad-all">
                <div class="media-body">
                    <p class="text-2x mar-no text-semibold">Marcas | Listado</p>
                    <p></p>
                </div>
            </div>
        </div>
            ...
            <div class="panel">
                ...
                <div class="panel-heading demo-icon">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            <a href="{{ route('marcas.create') }}"> <button class="button"><i
                                        class="ion-plus-circled lg"></i> Agregar nueva marca</button></a>
