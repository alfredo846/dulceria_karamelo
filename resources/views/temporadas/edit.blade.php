        ...
        <div class="col-md-12">
            <div class="panel panel-info panel-colorful media middle pad-all" style="background-color:#783449">
                <div class="media-body">
                    <p class="text-2x mar-no text-semibold"> Actualizar Temporada</p>
                    <p></p>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="panel">
                        ...
                        <form action="{{ route('temporadas.update', $temporada) }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="nombre" autocomplete="off" class="form-control"
                                            id="demo-is-inputnormal" value="{{ $temporada->nombre}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div id="imagePreview">
                                            <img class='fotoperfil' src="{{ asset('imagenes/temporadas/' . $temporada->imagen) }}"
                                                alt="" width="200px">
                                        </div>
