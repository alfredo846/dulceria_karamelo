        ...
        <div class="col-md-12">
            <div class="panel panel-primary panel-colorful media middle pad-all">
                <div class="media-body">
                    <p class="text-2x mar-no text-semibold">Temporadas | Listado</p>
                    <p></p>
                </div>
            </div>
        </div>
            ...
            <div class="panel">
                ...
                <div class="panel-heading demo-icon">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            <a href="{{ route('temporadas.create') }}"> <button class="button"><i
                                        class="ion-plus-circled lg"></i> Agregar nueva temporada</button></a>
                            ...
                            @foreach ($temporadas as $temporada)
                                <tr>
                                    ...
                                    <td><img class='profile-image'
                                            src="{{ asset('imagenes/temporadas/' . $temporada->imagen) }}" alt="foto">
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('temporadas.destroy', $temporada) }}" method="POST"
