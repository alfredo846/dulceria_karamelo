...
@section('title', 'Consultar temporada')
        ...
        <div class="col-md-12">
            <div class="panel panel-primary panel-colorful media middle pad-all">
                <div class="media-body">
                    <p class="text-2x mar-no text-semibold"> Consultar Temporada</p>
                    <p></p>
                </div>
            </div>
        </div><br><br><br>
                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                       <img class='profile-image-show' src="{{ asset('imagenes/temporadas/' . $temporada->imagen) }}" alt="foto">
                                    </div>
                                </div>
