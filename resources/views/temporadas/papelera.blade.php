        ...
        <div class="col-md-12">
            <div class="panel panel-primary panel-colorful media middle pad-all">
                <div class="media-body">
                    <p class="text-2x mar-no text-semibold">Temporadas | Papelera</p>
                    <p></p>
                </div>
            </div>
        </div>
        ...
        <div id="page-content">
            ...
            <div class="panel">
                ...
                <div class="panel-footer text-left">
                    <a href="{{ route('temporadas.index') }}" class="text-right fs-6 text-secundario add-tooltip"
                            ...
                            @foreach ($temporadas as $temporada)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('temporadas.activar', $temporada) }}" method="POST"
                                        ...
                                        <form action="{{ route('temporadas.borrar', $temporada) }}" method="POST"
